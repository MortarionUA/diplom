...
import com.gmail.dmytro.ui.view.admin.carrier.CarrierAdminView;
import com.gmail.dmytro.ui.view.admin.port.PortAdminView;
import com.gmail.dmytro.ui.view.admin.product.ProductAdminView;
import com.gmail.dmytro.ui.view.admin.user.UserAdminView;
...
public class MainView extends MainViewDesign implements ViewDisplay {
	...
	public void init() {
		...
		attachNavigation(carriers, CarrierAdminView.class);
		attachNavigation(ports, PortAdminView.class);
