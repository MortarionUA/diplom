...
import com.gmail.dmytro.ui.view.orderedit.OrderEditView;
...
public class StorefrontView extends StorefrontViewDesign implements View {
	...
	public void init() {
		...
		searchButton.addClickListener(e -> search(customerSearchField.getValue(), includePast.getValue()));
	...
	public void filterGrid(String searchTerm, boolean includePast) {
		...
		customerSearchField.setValue(searchTerm);
