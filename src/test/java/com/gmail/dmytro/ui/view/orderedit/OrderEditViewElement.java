...
public class OrderEditViewElement extends OrderEditViewDesignElement {
	...
	public static class OrderInfo {
		...
		Location pickup;
		Location delivery;
		List<ProductInfoElement.ProductOrderData> products;
		String total;
		OrderState state;
	}
	...
	public void setProducts(List<ProductInfoElement.ProductOrderData> products) {
		for (int i = 0; i < products.size(); i++) {
			ProductInfoElement.ProductOrderData product = products.get(i);
