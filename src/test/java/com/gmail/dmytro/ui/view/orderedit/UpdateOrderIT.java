...
public class UpdateOrderIT extends AbstractIT {
	...
	public void updateOrderInfo() {
		...
		OrderEditViewElement.OrderInfo currentOrder = orderEdit.getOrderInfo();
		OrderEditViewElement.OrderInfo updatedOrder = new OrderEditViewElement.OrderInfo();
		...
		for (int i = 0; i < currentOrder.products.size(); i++) {
			ProductInfoElement.ProductOrderData updatedProduct = new ProductInfoElement.ProductOrderData();
			updatedOrder.products.add(updatedProduct);
			ProductInfoElement.ProductOrderData currentProduct = currentOrder.products.get(i);
		...
		for (ProductInfoElement.ProductOrderData data : updatedOrder.products) {
	...
	public void updateButCancel() {
		...
		List<ProductInfoElement.ProductOrderData> products = new ArrayList<>();
		for (int i = 0; i < currentOrder.products.size(); i++) {
			ProductInfoElement.ProductOrderData updatedProduct = new ProductInfoElement.ProductOrderData();
